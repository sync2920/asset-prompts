# Final Prompt V7 — Exact Bust Volume + Dense Plain Black Tulle with Only Slight Sheerness
...
2. The second attached image is outfit and lighting direction only. Use it to keep the straight sleeveless outer shell, pale wide denim, clean summer light, and contemporary Japanese setting. Ignore its lace pattern, inner-layer color and shape, person, face, pose, body, and skin tone.
...
## Frame, pose, and light

- Photorealistic contemporary Japanese fashion editorial, 3:4 vertical.
- Frame from head to just below the knees so the square neckline, tank hem, tulle-covered waist zone, outer tulle hem, and denim waistband are all clearly inspectable.
- Natural 65 mm perspective with the camera near lower-rib height; no wide-angle enlargement or distortion.
- Quiet contemporary concrete-and-glass passage in Japan with a pale neutral background.
- Bright diffuse summer-morning daylight from the side-front with only soft edge separation on the tulle. Do not use strong backlight through the torso. Preserve realistic uncovered skin tone; do not turn black textile blue or grey.
- Relaxed three-quarter standing pose, weight on one leg, both arms resting slightly away from the torso, hands below the hips, chest and all garment boundaries completely unobstructed.
- Calm, natural expression as if checking the finished all-day outfit before leaving home.
- Realistic pores, individual hair strands, fine textile fibers, seams, stitches, drape, contact shadows, and depth.
